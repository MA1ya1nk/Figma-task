        ...
        <div className="features-inner">
          ...
          <div className="feature-row">
            ...
            <div className="feature-image">
              <img src="/src/assets/feature/security-shield.png" alt="control assets" />
            </div>
          </div>
          ...
          <div className="feature-row reverse">
            ...
            <div className="feature-image">
              <img src="/src/assets/feature/social.png" alt="social login" />
            </div>
          </div>
          ...
          <div className="feature-row">
            ...
            <div className="feature-image">
              <img src="/src/assets/feature/crypto-coins.png" alt="tokens" />
            </div>
          </div>
