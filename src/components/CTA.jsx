    ...
    <section className="py-24 overflow-hidden bg-black">
      <div className="max-w-7xl mx-auto px-6">
        <div className="relative rounded-3xl p-12 overflow-hidden" style={{ background: "linear-gradient(265.43deg, rgba(220,191,224,0.1) 2.36%, rgba(154,170,170,0.1) 94.29%)", border: "1px solid rgba(255,255,255,0.1)", backdropFilter: "blur(67px)" }}>
          ...
          <div className="relative grid lg:grid-cols-2 gap-12 items-center">
            {/* LEFT TEXT PART - RESTORED EXACTLY */}
            <div>
              <h2 className="text-4xl sm:text-5xl font-bold mb-4" style={{ fontFamily: "Georgia, serif" }}>
                <GradientText>Start building your portfolio with just $1</GradientText>
              </h2>
            ...
            {/* RIGHT IMAGE PART - ONLY ADDED IMAGES HERE */}
            <div className="relative flex justify-center items-center h-[400px] md:h-[500px]">
              {/* Secondary Phone (Back) */}
              <img 
                src="/assets/phone/right.png" 
                alt="" 
                className="absolute w-[240px] md:w-[600px] z-10 translate-x-25 rotate-[6deg] opacity-70"
              />
              {/* Primary Phone (Front) */}
              <img 
                src="/assets/phone/left.png" 
                alt="" 
                className="absolute w-[240px] md:w-[600px] z-20 -translate-x-10 translate-y-10 -rotate-[4deg] drop-shadow-[0_25px_50px_rgba(0,0,0,0.5)]"
              />
              {/* Floating Crypto Coins Asset */}
              <img 
                src="/assets/temp.png" 
                alt="" 
                className="absolute w-[140px] md:w-[200px] z-30 -right-4 top-50"
              />
            </div>
          </div>
        </div>
