    ...
    >
      ...
      <div className="relative max-w-[1300px] mx-auto px-6 text-center z-10">
        ...
        <div className="mb-10 md:mb-14">
          <h2
            className="text-[44px] leading-[1.1] md:text-[85px] font-bold text-white mb-4 tracking-tight"
            style={{ fontFamily: "'Clash Grotesk Display', sans-serif" }}
          >
            Better than <br className="block md:hidden" /> Banks
          </h2>

          <p className="text-white/90 text-lg md:text-2xl font-medium opacity-90 max-w-[260px] md:max-w-none mx-auto">
            Watch our quick intro video to learn more
          </p>
        </div>
        ...
        <div className="relative max-w-[1100px] mx-auto group">
          {/* PC: aspect-[21/9] (Wide)
              Mobile: aspect-[4/5] (Tall/Vertical like your image)
          */}
