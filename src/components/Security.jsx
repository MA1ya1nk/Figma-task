  ...
  return (
    <section className="bg-black py-24">
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
        <div>
          <h2 className="text-5xl sm:text-6xl font-bold text-white mb-6" style={{ fontFamily: "Georgia, serif" }}>Backed by the best</h2>
          <p className="text-white/60 text-xl leading-relaxed mb-8">Protected by a multi-level security architecture and is regularly audited to ensure that all of our users are safe.</p>
